...
const AdminLogin = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0A0505] flex items-center justify-center px-4 py-12 font-sans relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#8B0000]/12 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/2 pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-[#722F37]/8 rounded-full blur-[100px] translate-y-1/2 -translate-x-1/2 pointer-events-none" />
      ...
      <div className="max-w-md w-full relative z-10">
        <div className="bg-[#1A0707]/60 border border-white/10 rounded-[48px] p-12 backdrop-blur-[40px] shadow-[0_32px_64px_rgba(0,0,0,0.5)] relative overflow-hidden group">
          ...
          <div className="text-center mb-12">
            <div className="w-20 h-20 bg-[#8B0000]/15 text-[#D4AF37] rounded-[28px] flex items-center justify-center mx-auto mb-8 border border-white/10 shadow-2xl">
          ...
          <form onSubmit={handleLogin} className="space-y-8">
            <div className="space-y-3">
              ...
              <input
                ...
                className="w-full bg-white/5 border border-white/10 rounded-2xl py-5 px-8 text-white focus:outline-none focus:ring-2 focus:ring-[#8B0000]/40 transition-all font-medium placeholder:text-white/20"
                value={email}
                onChange={(e) => {
            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="请输入密码"
                  className="w-full bg-white/5 border border-white/10 rounded-2xl py-5 px-8 text-white focus:outline-none focus:ring-2 focus:ring-[#8B0000]/40 transition-all pr-16 font-medium placeholder:text-white/20"
                  value={password}
                  onChange={(e) => {
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-[#8B0000] to-[#722F37] hover:shadow-[0_0_30px_rgba(139,0,0,0.5)] text-white font-black py-5 rounded-2xl transition-all shadow-xl mt-6 text-lg disabled:opacity-50 uppercase tracking-[0.2em]"
            >
              {loading ? '正在验证...' : '登 录'}
            </button>
          </form>
